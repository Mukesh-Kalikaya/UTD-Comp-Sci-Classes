/* This program demonstrates the Date class. It reads dates from string arrays,
tests the overloaded relational and subtraction operators, and prints the
...
/* This function takes a string in mm/dd/yyyy/hh format and returns the month
as an integer. */
int getMonth(string d) {
	return stoi(d.substr(0, 2));
}

/* This function takes a string in mm/dd/yyyy/hh format and returns the day
as an integer. */
int getDay(string d) {
	return stoi(d.substr(3, 2));
}

/* This function takes a string in mm/dd/yyyy/hh format and returns the year
as an integer. */
int getYear(string d) {
	return stoi(d.substr(6, 4));
}

/* This function takes a string in mm/dd/yyyy/hh format and returns the hour
as an integer. */
int getHour(string d) {
